...
namespace DMZ.Internal
{
    ...
    /// </summary>
#if NETSTANDARD
    public sealed class SemVer : IComparable<SemVer>, IComparable
#else
    [Serializable]
    public sealed class SemVer : IComparable<SemVer>, IComparable, ISerializable
#endif
    {
        ...
        private SemVer(SerializationInfo info, StreamingContext context)
        {
        ...
        public SemVer(int major, int minor = 0, int patch = 0, string prerelease = "", string build = "")
        {
            Major = major;
            Minor = minor;
            Patch = patch;
        ...
        public SemVer Change(int? major = null, int? minor = null, int? patch = null,
        ...
        static int CompareComponent(string a, string b, bool lower = false)
        {
            ...
            for (var i = 0; i < minLen; i++)
            {
                var ac = aComps[i];
                var bc = bComps[i];
                var isanum = Int32.TryParse(ac, out var anum);
                var isbnum = Int32.TryParse(bc, out var bnum);
                int r;
                if (isanum && isbnum)
                {
